...
extern Datum memview_row_delete(PG_FUNCTION_ARGS);
extern Datum memview_row_insert(PG_FUNCTION_ARGS);
extern Datum memview_row_update(PG_FUNCTION_ARGS);
extern Datum memview_view_reset(PG_FUNCTION_ARGS);
extern Datum memview_view_scan(PG_FUNCTION_ARGS);
