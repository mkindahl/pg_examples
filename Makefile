...
DATA = simple--1.0.sql simple--1.0--2.0.sql manip--0.1.sql reporter--0.1.sql cplusplus--0.1.sql

REGRESS = basic update cplusplus
...
cplusplus.o: cplusplus.cpp include/c++/scanner.h
